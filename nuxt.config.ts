...
export default defineNuxtConfig({
  app: {
    ...
    head: {
      title: brand.hosting.name,
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: brand.hosting.desc },
        ...
        { property: 'og:url', content: brand.hosting.url },
        { property: 'og:title', content: brand.hosting.projectName },
        { property: 'og:description', content: brand.hosting.desc },
        { name: 'twitter:site', content: brand.hosting.url },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: brand.hosting.img },
        { property: 'og:image', content: brand.hosting.img },
